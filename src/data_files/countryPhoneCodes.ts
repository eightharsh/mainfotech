...
export const countryPhoneCodes: CountryPhoneCode[] = [
  ...
  { code: 'AI', dialCode: '+1-264', name: 'Anguilla' },
  { code: 'AQ', dialCode: '+672', name: 'Antarctica' },
  { code: 'AG', dialCode: '+1-268', name: 'Antigua and Barbuda' },
  ...
  { code: 'BB', dialCode: '+1-246', name: 'Barbados' },
  ...
  { code: 'BM', dialCode: '+1-441', name: 'Bermuda' },
  ...
  { code: 'VG', dialCode: '+1-284', name: 'British Virgin Islands' },
  ...
  { code: 'KY', dialCode: '+1-345', name: 'Cayman Islands' },
  ...
  { code: 'CI', dialCode: '+225', name: "Cote d'Ivoire" },
  ...
  { code: 'DM', dialCode: '+1-767', name: 'Dominica' },
  ...
  { code: 'GD', dialCode: '+1-473', name: 'Grenada' },
  { code: 'GP', dialCode: '+590', name: 'Guadeloupe' },
  { code: 'GU', dialCode: '+1-671', name: 'Guam' },
  ...
  { code: 'MS', dialCode: '+1-664', name: 'Montserrat' },
  ...
  { code: 'MP', dialCode: '+1-670', name: 'Northern Mariana Islands' },
  ...
  { code: 'KN', dialCode: '+1-869', name: 'Saint Kitts and Nevis' },
  { code: 'LC', dialCode: '+1-758', name: 'Saint Lucia' },
  { code: 'MF', dialCode: '+590', name: 'Saint Martin' },
  { code: 'PM', dialCode: '+508', name: 'Saint Pierre and Miquelon' },
  { code: 'VC', dialCode: '+1-784', name: 'Saint Vincent and the Grenadines' },
  ...
  { code: 'SX', dialCode: '+1-721', name: 'Sint Maarten' },
  ...
  { code: 'TC', dialCode: '+1-649', name: 'Turks and Caicos Islands' },
  { code: 'TV', dialCode: '+688', name: 'Tuvalu' },
  { code: 'VI', dialCode: '+1-340', name: 'U.S. Virgin Islands' },
