...
![Mehta Petro](https://mehtapetro.com/assets/125820963/cdf299bd-414a-4a2d-baf0-d188bb4709c7)

Mehta Petro is an **open-source template** designed for quick and efficient web project setup, blending **minimalism with functionality**. Whether you're showcasing a portfolio, launching a company landing page, or running a blog, Mehta Petro provides everything you need. By combining the power of the [Astro](https://astro.build/), [Tailwind CSS](https://tailwindcss.com/), and [Preline UI](https://preline.co/), this template offers a functional and aesthetically pleasing solution for your web presence.

<p align="left">
    <a href="https://mehtapetro.com" target="_blank">
      <img src="https://vyclk3sx0z.ufs.sh/f/hv6ttNERWpXuEoXgHPqIX9Ah5WFP01dfQ83jHCsek7VpiTDB" alt="Mehta Petro Site"/></a>
</p>

## Table of Contents

- [Why Choose Mehta Petro?](#why-choose-mehta-petro)
...
- [x] **Internationalization (i18n) Features**:
  ...
  - Developers can access the monolingual version directly from [`monolingual-site` branch](https://mehtapetro.com).
...
> [!NOTE]
> Currently, there are no planned improvements or known bugs. If you encounter any issues, please report them on our [issues page](https://mehtapetro.com) or [start a discussion](https://mehtapetro.com) to share ideas, suggestions, or ask questions.
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fmehtapetro.com)

### Deploying to Netlify

Click the button below to start deploying your project on Netlify:

[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://mehtapetro.com)

## Project Structure

Mehta Petro organizes modular components, content, and layouts to streamline development and content management.
...
Mehta Petro allows for easy customization to suit your specific needs. Here are a couple of ways you can configure components and content:
...
const subTitle: string =
  'At Mehta Petro, we tackle the unique challenges encountered in the hardware and construction sectors.';
```
...
![Mehta Petro MegaMenu](https://github.com/user-attachments/assets/690482af-f1a4-4ebf-be58-eca0b5862973)

## Integrations and Enhancements

### Starlight Documentation

Mehta Petro is now equipped with Starlight, designed to elevate the user experience with documentation. This modern and elegant theme includes a suite of features to make content more accessible and enjoyable to navigate.
...
The SEO Configuration in the Mehta Petro template is designed to empower users in optimizing their website's visibility on search engines and social media platforms. This documentation outlines the implementation details and usage instructions for effectively managing SEO settings.
